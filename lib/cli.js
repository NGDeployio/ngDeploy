...
function additional_help(){
    ...
    console.log(chalk.yellow('    $ ngdeploy create appName -a <AccountToken>'));
    console.log(chalk.yellow('    $ ngdeploy init <appName> <dist dir> -a <AccountToken>'));
...
function _delete(id, accountToken){
    request
        .del({
            ...
            if(body){
                return console.log("Deleted app ", body);
            }
        });
}

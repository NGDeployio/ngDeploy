...
function init(appName, dist,opts) {
    ...
    if(opts.accesskey)
        system.accesskey=opts.accesskey;
...
function upload() {
    ...
    //system = fs.readFileSync(".ngdeploy");
...
//        console.log(system.name+"/"+file.path + ' -> ' + system.name+".ngdeploy.com/"+file.path)
//    });
//
//    files.pipe(uploader);
//}
//
//function upload_folder2(system,access_key,secret_key,token) {
//
...
//        client.sync(system.dist, system.name+"/");
//    }).catch(function (err) {
//        console.log("Error:");
//    });
//}
